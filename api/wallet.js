...
export default async function handler(req,res){
  ...
  try{
    ...
    return res.status(200).json({success:true,scannedAt:new Date().toISOString(),wallet:address,solBalance:snapshot.solBalance,tokenCount:holdings.length,portfolioTokenValueUsd,holdings})
  }catch(error){
