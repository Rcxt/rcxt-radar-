...
export const SCORE_VERSION = '6.0.0-rc.1'
...
export function analyzePair(pair, mintSecurity = null) {
  ...
  const contractVerified = Boolean(mintSecurity?.available) && !mintSecurity?.mintAuthority && !mintSecurity?.freezeAuthority && !authorityConflict
